  ...
  function srcAppLogintypeLogintypePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LogintypePage = class LogintypePage {
      ...
      constructor(alertCtrl, menuCtrl, router, _global, httpClient, loadingController, myapp, route) {
        ...
        this.route = route;
        this.price = '';
        this.menuCtrl.enable(true); //this.price = this.route.snapshot.params['price'];
      }
