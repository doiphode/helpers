(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\">\n      <ion-content>\n        <ion-list id=\"inbox-list\">\n          <ion-list-header *ngIf=\"aboutmenu == 1\" (click)=\"openLoginType()\">\n              <ion-back-button defaultHref=\"logintype\"></ion-back-button>\n              </ion-list-header>\n          <ion-list-header>{{userfullname}}</ion-list-header>\n          <ion-note>{{useremail}}</ion-note>\n\n          <div *ngIf=\"menutype == 1\">\n             <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\" > \n\n              <!-- About -->\n              <ion-item *ngIf=\"p.title == 'About'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n\n                  <img src=\"assets/icon/phone.png\" style='width: 24px;margin-right: 32px; margin-left: 2px; ' >\n                  <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n              </ion-item>\n\n              <ion-item *ngIf=\"p.title != 'About'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n              </ion-item>\n          </ion-menu-toggle>\n          </div>\n          \n          <div *ngIf=\"menutype == 2\">\n              <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\" > \n                <!-- Switch user type -->\n                <ion-item *ngIf=\"p.title == 'Switch user type'\" (click)=\"switchusertype()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\" style=\"display: none;\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Donate -->\n                <ion-item *ngIf=\" p.title=='Donate' \" (click)=\"donate()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- My requests -->\n                <ion-item *ngIf=\"p.title == 'My requests'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <img src=\"assets/icon/interface.png\" style='width: 20px;margin-right: 35px; margin-left: 2px; ' >\n                    <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Make a request -->\n                <ion-item *ngIf=\"p.title == 'Make a request'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <img src=\"assets/icon/gesture.png\" style='width: 21px;margin-right: 35px; ' >\n                    <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Notifications -->\n                <ion-item *ngIf=\"p.title == 'Notifications'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                  <ion-badge class=\"notifybadge\" *ngIf=\"notifycount > 0\" >{{notifycount}}</ion-badge>\n                </ion-item>\n\n                <!-- About -->\n                <ion-item *ngIf=\"p.title == 'About'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <img src=\"assets/icon/phone.png\" style='width: 20px;margin-right: 35px; margin-left: 2px; ' >\n                    <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n                </ion-item>\n\n                <ion-item *ngIf=\"p.title != 'Switch user type' && p.title!='Donate' && p.title!='Logout' && p.title != 'My requests' && p.title != 'Make a request' && p.title != 'About' && p.title != 'Notifications' \" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Logout -->\n                <ion-item *ngIf=\"p.title=='Logout' \" (click)=\"logout()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n              </ion-menu-toggle>\n          </div>\n          \n          <div *ngIf=\"menutype == 3\">\n              <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\" > \n                <!-- Switch user type -->\n                <ion-item *ngIf=\"p.title == 'Switch user type'\" (click)=\"switchusertype()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\" style=\"display: none;\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- About -->\n                <ion-item *ngIf=\"p.title == 'About'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <img src=\"assets/icon/phone.png\" style='width: 20px;margin-right: 35px; margin-left: 2px; ' >\n                    <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n                </ion-item>\n                \n                <!-- Donate -->\n                <ion-item *ngIf=\" p.title=='Donate' \" (click)=\"donate()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- My requests -->\n                <ion-item *ngIf=\"p.title == 'My help list'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <img src=\"assets/icon/interface.png\" style='width: 20px;margin-right: 35px; margin-left: 2px; ' >\n                    <ion-label class=\"appicon\">{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Notifications -->\n                <ion-item *ngIf=\"p.title == 'Notifications'\" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                    <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                  <ion-badge class=\"notifybadge\" *ngIf=\"notifycount > 0\" >{{notifycount}}</ion-badge>\n                </ion-item>\n\n                <ion-item *ngIf=\"p.title != 'Switch user type' && p.title!='Donate' && p.title!='Logout' && p.title != 'About' && p.title != 'My help list' && p.title != 'Notifications' \" (click)=\"selectedIndex = i\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n\n                <!-- Logout -->\n                <ion-item *ngIf=\"p.title=='Logout' \" (click)=\"logout()\" routerDirection=\"root\" lines=\"none\" detail=\"false\" [class.selected]=\"selectedIndex == i\">\n                  <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n                  <ion-label>{{ p.title }}</ion-label>\n                </ion-item>\n              </ion-menu-toggle>\n          </div>\n\n        </ion-list>\n        \n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      path: 'myrequests',
      loadChildren: () => __webpack_require__.e(
      /*! import() | staff-myrequests-myrequests-module */
      "staff-myrequests-myrequests-module").then(__webpack_require__.bind(null,
      /*! ./staff/myrequests/myrequests.module */
      "./src/app/staff/myrequests/myrequests.module.ts")).then(m => m.MyrequestsPageModule)
    }, {
      path: 'requests',
      loadChildren: () => __webpack_require__.e(
      /*! import() | staff-requests-requests-module */
      "staff-requests-requests-module").then(__webpack_require__.bind(null,
      /*! ./staff/requests/requests.module */
      "./src/app/staff/requests/requests.module.ts")).then(m => m.RequestsPageModule)
    }, {
      path: 'foodrequest/:id/:view/:request',
      loadChildren: () => __webpack_require__.e(
      /*! import() | staff-foodrequest-foodrequest-module */
      "staff-foodrequest-foodrequest-module").then(__webpack_require__.bind(null,
      /*! ./staff/foodrequest/foodrequest.module */
      "./src/app/staff/foodrequest/foodrequest.module.ts")).then(m => m.FoodrequestPageModule)
    }, {
      path: 'essentialsrequest/:id/:view/:request',
      loadChildren: () => __webpack_require__.e(
      /*! import() | staff-essentialsrequest-essentialsrequest-module */
      "staff-essentialsrequest-essentialsrequest-module").then(__webpack_require__.bind(null,
      /*! ./staff/essentialsrequest/essentialsrequest.module */
      "./src/app/staff/essentialsrequest/essentialsrequest.module.ts")).then(m => m.EssentialsrequestPageModule)
    }, {
      path: 'childcarerequest/:id/:view/:request',
      loadChildren: () => __webpack_require__.e(
      /*! import() | staff-childcarerequest-childcarerequest-module */
      "staff-childcarerequest-childcarerequest-module").then(__webpack_require__.bind(null,
      /*! ./staff/childcarerequest/childcarerequest.module */
      "./src/app/staff/childcarerequest/childcarerequest.module.ts")).then(m => m.ChildcarerequestPageModule)
    }, {
      path: 'helperlogin',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helperlogin-helperlogin-module */
      "helperlogin-helperlogin-module").then(__webpack_require__.bind(null,
      /*! ./helperlogin/helperlogin.module */
      "./src/app/helperlogin/helperlogin.module.ts")).then(m => m.HelperloginPageModule)
    }, {
      path: 'searchhospitals',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-searchhospitals-searchhospitals-module */
      "helper-searchhospitals-searchhospitals-module").then(__webpack_require__.bind(null,
      /*! ./helper/searchhospitals/searchhospitals.module */
      "./src/app/helper/searchhospitals/searchhospitals.module.ts")).then(m => m.SearchhospitalsPageModule)
    }, {
      path: 'viewrequests/:id/:name',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-viewrequests-viewrequests-module */
      "helper-viewrequests-viewrequests-module").then(__webpack_require__.bind(null,
      /*! ./helper/viewrequests/viewrequests.module */
      "./src/app/helper/viewrequests/viewrequests.module.ts")).then(m => m.ViewrequestsPageModule)
    }, {
      path: 'foodrequestdetails/:id/:view',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-foodrequestdetails-foodrequestdetails-module */
      "helper-foodrequestdetails-foodrequestdetails-module").then(__webpack_require__.bind(null,
      /*! ./helper/foodrequestdetails/foodrequestdetails.module */
      "./src/app/helper/foodrequestdetails/foodrequestdetails.module.ts")).then(m => m.FoodrequestdetailsPageModule)
    }, {
      path: 'essentialsrequestdetails/:id/:view',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-essentialsrequestdetails-essentialsrequestdetails-module */
      "helper-essentialsrequestdetails-essentialsrequestdetails-module").then(__webpack_require__.bind(null,
      /*! ./helper/essentialsrequestdetails/essentialsrequestdetails.module */
      "./src/app/helper/essentialsrequestdetails/essentialsrequestdetails.module.ts")).then(m => m.EssentialsrequestdetailsPageModule)
    }, {
      path: 'childcarerequestdetails/:id/:view',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-childcarerequestdetails-childcarerequestdetails-module */
      "helper-childcarerequestdetails-childcarerequestdetails-module").then(__webpack_require__.bind(null,
      /*! ./helper/childcarerequestdetails/childcarerequestdetails.module */
      "./src/app/helper/childcarerequestdetails/childcarerequestdetails.module.ts")).then(m => m.ChildcarerequestdetailsPageModule)
    }, {
      path: 'myhelplist',
      loadChildren: () => __webpack_require__.e(
      /*! import() | helper-myhelplist-myhelplist-module */
      "helper-myhelplist-myhelplist-module").then(__webpack_require__.bind(null,
      /*! ./helper/myhelplist/myhelplist.module */
      "./src/app/helper/myhelplist/myhelplist.module.ts")).then(m => m.MyhelplistPageModule)
    }, {
      path: 'forgotpwd',
      loadChildren: () => __webpack_require__.e(
      /*! import() | forgotpwd-forgotpwd-module */
      "forgotpwd-forgotpwd-module").then(__webpack_require__.bind(null,
      /*! ./forgotpwd/forgotpwd.module */
      "./src/app/forgotpwd/forgotpwd.module.ts")).then(m => m.ForgotpwdPageModule)
    }, {
      path: 'notifications',
      loadChildren: () => __webpack_require__.e(
      ...
      path: 'termcondition',
      loadChildren: () => __webpack_require__.e(
      /*! import() | termcondition-termcondition-module */
      "termcondition-termcondition-module").then(__webpack_require__.bind(null,
      /*! ./termcondition/termcondition.module */
      "./src/app/termcondition/termcondition.module.ts")).then(m => m.TermconditionPageModule)
    }, {
      path: 'donate',
      loadChildren: () => __webpack_require__.e(
      ...
      "./src/app/donate/donate.module.ts")).then(m => m.DonatePageModule)
    }, {
      path: 'givefeedback',
      loadChildren: () => __webpack_require__.e(
      /*! import() | givefeedback-givefeedback-module */
      "givefeedback-givefeedback-module").then(__webpack_require__.bind(null,
      /*! ./givefeedback/givefeedback.module */
      "./src/app/givefeedback/givefeedback.module.ts")).then(m => m.GivefeedbackPageModule)
    }, {
      path: 'about',
      loadChildren: () => __webpack_require__.e(
      ...
      "./src/app/policy/policy.module.ts")).then(m => m.PolicyPageModule)
    }];
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff)); }\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px; }\n\nion-menu.md ion-list {\n  padding: 20px 0; }\n\nion-menu.md ion-note {\n  margin-bottom: 30px; }\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px; }\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #d7d8da); }\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px; }\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px; }\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px; }\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14); }\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary); }\n\nion-menu.md ion-item ion-icon {\n  color: #616e7e; }\n\nion-menu.md ion-item ion-label {\n  font-weight: 500; }\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px; }\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0; }\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px; }\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px; }\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary); }\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: #73849a; }\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px; }\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px; }\n\nion-menu.ios ion-note {\n  margin-bottom: 8px; }\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade); }\n\nion-item.selected {\n  --color: var(--ion-color-primary); }\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@ionic-native/badge/ngx/index.js"); //import { PayPal, PayPalPayment, PayPalConfiguration } from '@ionic-native/paypal/ngx';


    let AppComponent = class AppComponent {
      constructor(platform, splashScreen, statusBar, _global, httpClient, router, menuCtrl, socialSharing, fcm, //private payPal: PayPal,
      alertCtrl, nativeStorage, badge) {
        ...
        this.helpcontactmsg = "* We suggest you contact the concerned NHS staff to confirm the above request to accommondate any possible changes they may want to make.";
        this.loginmenu_arr = [{
          title: 'Home',
          url: '/logintype',
          icon: 'home'
        ...
        this.appPages = [];
        this.initializeApp();
        this.appPages = this.loginmenu_arr; //events.subscribe('user:helperlogin',()=>{
        //  this.appPages = this.helperappPages;
        //});
      }

      getFromStorage() {
        this.nativeStorage.getItem('loginkey').then(data => {
      ...
      initializeApp() {
        this.platform.ready().then(() => {
          ...
          this.splashScreen.hide(); // FCM (start)

          this.fcm.getToken().then(token => {
            console.log(token); // alert("get token2 : " + token);
          ...
          this.fcm.onTokenRefresh().subscribe(token => {
            console.log(token); //alert("refresh token : " + token);
          });
          this.fcm.onNotification().subscribe(data => {
            ...
            if (data.wasTapped) {
              ...
              var type = data.type; // alert("page : " + page + ", request: " + requestid + ", role : " + userrole + ", type : " + type);
              // Staff
          ...
          this.fcm.unsubscribeFromTopic('marketing'); // FCM (end)
        });
      }
      ...
      switchusertype() {
        if (this._global.userrole == 2) {
          ...
          if (this._global.userid > 0) this.helpermenu();else this.helpermenunologin();
          this.router.navigateByUrl('/searchhospitals');
        } else {
          console.log("switch user type3 : " + this._global.userrole);
          this._global.userrole = 2;
          if (this._global.userid > 0) this.staffmenu();else this.staffmenunologin();
      ...
      logout() {
        ...
        clearInterval(this._global.helpertimer); // Delete user token (start)
      ...
      checklogin(email, password) {
        this.httpClient.post(this._global.domainURL + "login", {
          ...
          if (!val.data.success) {
            ...
            this.addNameEmailtoMenu(val.data.name, val.data.email); // Notification count

            this.notifycount = val.data.countnotification; //  alert("requestid : " + this.nrequestid + ", role : " + this.nrequestuserrole + ", type : " + this.nrequestType);

            if (this.nrequestid > 0 && this.nrequestuserrole == this._global.userrole) {
              var requestid = this.nrequestid;
              var rtype = this.nrequestType; // Staff
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _global_service__WEBPACK_IMPORTED_MODULE_5__["GlobalService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_8__["SocialSharing"], _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_10__["FCM"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_9__["NativeStorage"], _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_11__["Badge"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _global_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./global.service */
    "./src/app/global.service.ts");
    /* harmony import */
    ...
    var _ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @ionic-native/sms/ngx */
    "./node_modules/@ionic-native/sms/ngx/index.js");
    /* harmony import */


    var _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! @ionic-native/badge/ngx */
    "./node_modules/@ionic-native/badge/ngx/index.js"); //import { PayPal, PayPalPayment, PayPalConfiguration } from '@ionic-native/paypal/ngx';
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _global_service__WEBPACK_IMPORTED_MODULE_10__["GlobalService"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_11__["Geolocation"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_12__["SocialSharing"], _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_13__["FCM"], _ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_15__["AndroidPermissions"], _ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_16__["SMS"], // PayPal,
      _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_14__["NativeStorage"], _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_17__["Badge"], {
  ...
  function srcAppGlobalServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let GlobalService = class GlobalService {
      constructor(toastController, router, httpClient, geolocation, nativeStorage, androidPermissions, sms) {
        ...
        this.userrole2 = 0;
        this.username = '';
        this.loadermsg1 = "Please wait...";
        this.loadermsg2 = "Please wait while data is Loading ...";
        this.isLive = true;
      ...
      presentLoading(el, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          let loading = yield el.loadingController.create({
            message: messageTxt
          });
      ...
      dismiss(el) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          return yield el.loadingController.dismiss().then(() => console.log('dismissed'));
        });
      ...
      saveToStorage(email, password, role) {
        this.nativeStorage.setItem('loginkey', {
          'email': email,
          'pwd': password,
          'role': role
        }).then(data => console.log('stored'), error => console.error('Error storing item', error));
      }

      clearStorage() {
        this.nativeStorage.clear().then(data => console.log(data), error => console.error(error));
      }
      ...
      sendSMS(contactno, message) {
        ...
        this.sms.send(contactno, message, options).then(result => {// alert("sent: " + JSON.stringify(result));
    ...
    GlobalService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_4__["Geolocation"], _ionic_native_native_storage_ngx__WEBPACK_IMPORTED_MODULE_5__["NativeStorage"], _ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_7__["AndroidPermissions"], _ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_8__["SMS"]])], GlobalService);
    /***/
  },
